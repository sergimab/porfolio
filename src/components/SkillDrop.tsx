...
const projects: Record<string, { id: string; title: string; titleEn: string; cover?: string }[]> = {
  ...
  iberdrola:  [{ id:"i2",title:"Sistema de diseño",titleEn:"Design system"},{id:"i5",title:"Sistema de ilustraciones",titleEn:"Illustration system",cover:"/images/covers/sistema-ilustraciones.svg"},{id:"i1",title:"Infografías",titleEn:"Infographics",cover:"/images/covers/infografias.svg"},{id:"i3",title:"Newsletters",titleEn:"Newsletters",cover:"/images/covers/newsletters.png"},{id:"i4",title:"Iconografía",titleEn:"Iconography",cover:"/images/covers/iberdrola-iconografia.svg"}],
