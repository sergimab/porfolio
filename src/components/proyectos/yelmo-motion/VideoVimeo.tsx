...
export default function VideoVimeo({
  ...
  hash: string;
  titulo: string;
  /** Proporción de la CAJA. La del vídeo no cambia: si no coinciden, se
      centra y quedan franjas negras, como en una pantalla de cine. */
  proporcion?: string;
}) {
  ...
  return (
    <div className="ym-vimeo" ref={caja} style={proporcion ? { aspectRatio: proporcion } : undefined}>
