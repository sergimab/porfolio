...
const TOOLS: { name: string; brand: string; node: React.ReactNode }[] = [
  ...
  {
    // Daz Studio: logo oficial (la silueta). Monocromo con currentColor, como
    // el resto, para que tome el color de marca en hover.
    name: "Daz Studio",
    brand: "#00A9E0",
    node: (
      <svg viewBox="0 0 516.99 385.44" aria-hidden="true">
        <g fill="currentColor">
          <path d="M284.98.77c74.16-3.12,150.91,30.39,173.15,106.45,5.22,28.18,20.81,47.85,48.09,56.94,6.6,3.25,10.1,6.37,10.75,13.56l.02,9.33c-.65,6.36-2.19,11.75-7.09,16.2-8.15,4.69-7.67,11.98-2.34,18.79,8.64,4.89,4,14.41-1.89,19.56,4.28,2.96,5.91,6.52,4.88,10.7-3.33,5.05-6.38,10.18-9.16,15.39l5.6,21.55c3.27,27.53-16.7,45.01-43.51,41.94-31.66-3.36-62.94-2.54-93.87,2.48l-15.48,4.71c-26.54,10.35-52.33,22.38-77.35,36.08-30.04,14.42-72.06,15.27-101.35-1.19-29.55-16.61-34.28-52.11,3.16-62.26l34.2-4.44c18.5-3.31,29.28-9.25,38.79-25.95,11.99-21.03,7.35-39.29-7.4-57.29-.92-1.98-.19-2.48,2-2.72,7.39-.8,28.23,11.1,34.62,16.01,34.79,26.71,34.71,68.49,19.39,106.67,19.83-24.75,26.43-58.27,13.88-87.76-19.97-46.91-84.29-57.31-129.57-50.95-58.18,8.16-81.55,43.43-108.82,92.32-11.78,18.34-33.6,38.01-56.96,29.68C5.2,321.76.43,309.84,0,296.48v-10.6c2.95-39.66,46.77-74.99,80.69-90.67,26.6-10.29,52.73-22.7,78.38-37.21,17.57-9.8,51.1-42.01,36.17-63.45-14.04-20.17-62.87-15.72-83.5-8.1-12.11,4.9-24.32,9.27-36.65,13.1-.43.75-.14,1.1.78,1.1,24.71-10.76,71.58-19.33,96.82-7.74,19.31,8.87,9.48,30.63-3.11,41.48-24.46,21.07-69.07,44.78-100.85,54.13-14.38,4.23-40.98,10.91-49.32-5.54-11.56-22.82,13.85-57.2,28.6-73.6C100.83,50.7,172.64-2.08,254.04.85c9.39-1.15,21.24-1.08,30.94-.07Z" />
          <path d="M75.1,99.56l.78,1.1c-1.59.47-3.15,2.06-6.45,1.31,1.62-1.28,3.79-1.52,5.68-2.4Z" />
        </g>
      </svg>
    ),
  },
  {
    ...
    node: (
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <rect x="1.5" y="1.5" width="21" height="21" rx="4.5" fill="none" stroke="currentColor" strokeWidth="1.4" />
        <text x="12" y="12.4" textAnchor="middle" dominantBaseline="central" fontSize="9.5" fontWeight="600" fill="currentColor">Id</text>
      </svg>
    ),
  },
  {
