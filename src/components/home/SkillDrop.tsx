...
const projects: Record<string, { id: string; title: string; titleEn: string; cover?: string }[]> = {
  motion:     [{ id:"m1",title:"Motion Yelmo Cines",titleEn:"Yelmo Cines motion",cover:"/covers/motion-yelmo.webp"},{id:"m2",title:"Motion El Arte del Miedo",titleEn:"The Art of Fear motion",cover:"/covers/el-arte-del-miedo-motion.webp"},{id:"m3",title:"Proyecto Motion 03",titleEn:"Motion Project 03"}],
  ...
  fotografia: [{ id:"f1",title:"Afiche Orquesta Tokio",titleEn:"Orquesta Tokio poster",cover:"/covers/orquesta-tokio.webp"},{id:"f2",title:"Proyecto Foto 02",titleEn:"Photo Project 02"},{id:"f3",title:"Proyecto Foto 03",titleEn:"Photo Project 03"}],
