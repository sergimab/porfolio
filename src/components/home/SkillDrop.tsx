...
const projects: Record<string, { id: string; title: string; titleEn: string; cover?: string }[]> = {
  motion:     [{ id:"m1",title:"Motion Yelmo Cines",titleEn:"Yelmo Cines motion"},{id:"m2",title:"Proyecto Motion 02",titleEn:"Motion Project 02"},{id:"m3",title:"Proyecto Motion 03",titleEn:"Motion Project 03"}],
