...
const projects: Record<string, { id: string; title: string; titleEn: string; cover?: string }[]> = {
  ...
  fotografia: [{ id:"f1",title:"Afiche Orquesta Tokio",titleEn:"Orquesta Tokio poster"},{id:"f2",title:"Proyecto Foto 02",titleEn:"Photo Project 02"},{id:"f3",title:"Proyecto Foto 03",titleEn:"Photo Project 03"}],
