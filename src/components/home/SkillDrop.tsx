...
const projects: Record<string, { id: string; title: string; titleEn: string; cover?: string }[]> = {
  ...
  uiux:       [{ id:"u1",title:"Web de Elysium",titleEn:"Elysium website",cover:"/covers/elysium-web.webp"},{id:"u2",title:"Proyecto UI/UX 02",titleEn:"UI/UX Project 02"},{id:"u3",title:"Proyecto UI/UX 03",titleEn:"UI/UX Project 03"}],
